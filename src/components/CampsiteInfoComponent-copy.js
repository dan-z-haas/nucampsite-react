    ...
    render() {
        return(
            <React.Fragment>
                ...
                <CommentModal isModalOpen={this.state.isModalOpen} toggleModal={this.toggleModal} addComment={this.props.addComment}/>
            </React.Fragment>
        )
    }
}
...
class CommentModal extends Component {
    constructor(props) {
        ...
        this.props.addComment = this.addComment.bind(this);
    }
